...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Note.homepage_width'
        db.add_column(u'notes_note', 'homepage_width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Note.homepage_width'
        db.delete_column(u'notes_note', 'homepage_width')
