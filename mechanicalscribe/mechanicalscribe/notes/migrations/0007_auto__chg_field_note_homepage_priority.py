...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Note.homepage_priority'
        db.alter_column(u'notes_note', 'homepage_priority', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Note.homepage_priority'
        db.alter_column(u'notes_note', 'homepage_priority', self.gf('django.db.models.fields.IntegerField')())
